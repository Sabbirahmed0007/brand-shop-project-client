...
const DisplaySingleData = ({data}) => {
    ...
    return (
        <div>
            <div className='my-10 mx-4 bg-slate-200 drop-shadow-lg rounded-md'>
                <img src={photo} alt="" className='w-full h-80 rounded-t-md' />
                <div className='mx-5 py-4'>
                    <h1 className='my-2 text-xl font-bold uppercase'>{name}</h1>
                    ...
                    <h1><ellipse title={description}>{description.slice(0,150)} ...</ellipse></h1>
                </div>
            </div>
        </div>
    );
