            ...
            <div className='grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-5 my-10 mx-5'>
                {
                    testimonials.map(testimonial=>
                        <div key={testimonial.id} className=''>
                            <div className='bg-cyan-600 text-white p-2 py-6 rounded-md'>
                                <h2 className='text-center my-1 font-medium'>{testimonial.date}</h2>
                                <h1 className='text-center my-1 text-lg font-extrabold'>{testimonial.name}</h1>
                                <p className='text-center my-1 font-semibold'><span className='font-bold'>Rating: </span>{testimonial.rating}</p>
                                <p className='text-center my-1 font-medium'><span className='font-extrabold text-fuchsia-200'>Testimonial: </span>{testimonial.comment}</p>
                            </div>
