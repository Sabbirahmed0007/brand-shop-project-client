...
const Brands = () => {
    ...
    return (
        <div className='max-w-screen-2xl mx-auto'>
            <div className='mt-20 text-center mx-2'>
                <h1 className='uppercase font-extrabold text-xl '> Discover Our Top Brands Collection</h1>
            ...
            <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-5 mb-16 mt-8 justify-evenly items-center  gap-4'>
